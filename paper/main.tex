...
% ===================================================================== %
% LAYOUT TOGGLE.  Default = single-column preprint (for arXiv).          %
% To submit to ACL: uncomment the [ACL] line below, then comment out     %
% every line tagged % [PREPRINT] (this block + \usepackage{hyperref} +   %
% \bibliographystyle{acl_natbib} near \bibliography). acl.sty supplies    %
% geometry, natbib, hyperref, the two-column layout, and the bib style.  %
%\usepackage[preprint]{acl}                          % [ACL] two-column (review/preprint/final)
\usepackage[margin=1in]{geometry}                    % [PREPRINT] single-column margins
\usepackage{natbib}                                  % [PREPRINT] acl.sty loads this
\renewcommand{\cite}{\citep}                         % [PREPRINT] \cite -> "(Author, Year)"
% ===================================================================== %
\usepackage{times}
\usepackage{latexsym}
...
\usepackage{booktabs}
\usepackage{xcolor}
\usepackage{hyperref}             % [PREPRINT] after natbib (\url + clickable refs); acl.sty loads its own
\hypersetup{hidelinks}            % [PREPRINT] no colored boxes around links/cites
...
ships none) are available at \url{https://github.com/elroy-galbraith/stablize_CRAG};
every per-question metric and the
...
this in \texttt{experiments/\allowbreak global\_corpus.py}.
...
\bibliographystyle{acl_natbib}  % [PREPRINT] comment this when [ACL] is on (acl.sty sets it)
\bibliography{refs}
