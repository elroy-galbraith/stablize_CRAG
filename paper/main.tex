...
stabilization. Stabilization is typically early: at a realistic operating point a
\streamPct{} streamable fraction of the benchmark admits latency hiding, and $H$
acts as a conservative aggregate floor that realized savings meet or exceed---though
it does not predict savings query by query. Question type yields a statistically
...
relaxed grounding); question type gives a significant but coarse
